...
<html>
	<head>
		<meta charset="utf-8" />
		<title>ForFuture Share Manager</title>
		<!-- Favicons -->
	...
	<body style="background:url('../img/background.jpg') no-repeat;">
		...
		<div class="container">
			<form class="form-horizontal col-md-4 col-md-offset-4" method="post" action="<%=basePath%>AdminServlet.action?flag=login">
				<!-- 
					<center style="font-size:18px;color:red;font-weight:bold;">${msg}</center>
				 -->
				<h2 class="text-center text">Manager login</h2>
		...
		<footer class="navbar navbar-fixed-bottom text-center">
			<span><a href="http://ganquanzhong.top">ForFuture</a>科技集团&nbsp;版权所有&copy; since 2017</span>
		</footer>
